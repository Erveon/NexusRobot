...
exports.getMaster = function(callback){
	...
	con.getConnection(function(err, connection) {
		if(err) throw err;
		connection.query(sqlNudesGetMaster, function(err, res) {
			if (err) throw err;
			callback(res);
			connection.release();
		});
...
exports.loadCommands = function(callback){
	var sqlCommandLoad = "SELECT * FROM custom_commands";
	con.getConnection(function(err, connection) {
		if (err) throw err;
		connection.query(sqlCommandLoad, function(err, res) {
			if (err) throw err;
...
exports.countCommands = function(callback){
	var sqlCommandCount = "SELECT COUNT(command_name) FROM custom_commands";
	con.getConnection(function(err, connection){
		if (err) throw err;
		connection.query(sqlCommandCount,function(err, res){
			if (err) throw err;
